...
public class CharacterController2D : MonoBehaviour {
	...
	private float fallMultipler = 3.0f;
	...
	public void addForce (float x, float y) {
		m_Rigidbody2D.velocity = new Vector2(0, 0); /*Reset values so the previous velocity isn't added to the new one*/
		m_Rigidbody2D.AddForce(new Vector2(x, y));
	}

	public void highJump() {
		m_Rigidbody2D.velocity += Vector2.up * Physics2D.gravity.y * (fallMultipler - 1) * Time.deltaTime;
	}
	...
	public void setFacingRight(bool m_FacingRight) {
